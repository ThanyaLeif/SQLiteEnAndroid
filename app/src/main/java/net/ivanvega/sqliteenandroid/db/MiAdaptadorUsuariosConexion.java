...
public class MiAdaptadorUsuariosConexion extends SQLiteOpenHelper {
    ...
    public static final String [] COLUMNS_USUARIOS = {"_id", "nombre", "telefono", "email", "red_social", "fecha_nac"  };
    ...
    private String SCRIPT_DB  = "create table Usuarios (_id integer primary key autoincrement, " +
            "nombre text not null, telefono text, email text, red_social text, fecha_nac string );";
